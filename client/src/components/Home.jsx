...
const Home = ({ language }) => {
  ...
  const translations = {
    vi: {
      ...
      heroType:
        "Kết nối tài liệu số, kỹ năng mềm, bài tập trắc nghiệm và AI Gemini vào một website duy nhất.",
      heroDesc:
        "Website hỗ trợ học sinh, sinh viên chủ động học tập trong kỷ nguyên số: xem tài liệu PDF, video, hình ảnh từ Google Drive; luyện kỹ năng tự học, kỹ năng sống; làm bài trắc nghiệm có chấm điểm; và tương tác với Gemini ngay trên trang web.",
      ...
      sections: [
        ...
        },
        {
          ...
          points: [
            ...
            "ChatBot Gemini tích hợp trực tiếp trên website",
      ...
      howSteps: [
        ...
        "Bước 4: Sử dụng Gemini tích hợp để hỏi thêm, tìm gợi ý, giải thích nội dung khó.",
    ...
    en: {
      ...
      heroType:
        "Connecting digital materials, life skills, quizzes and AI Gemini into one website.",
      heroDesc:
        "This website helps students become active learners in the digital era: view PDFs, videos, images from Google Drive; practice self-learning and life skills; take auto-graded quizzes; and interact with Gemini directly on the site.",
      ...
      sections: [
        ...
        {
          key: "chatbot",
          title: "3. AI Gemini integration",
          route: "/chatbot",
          icon: <MessageCircle className="w-7 h-7" />,
          points: [
            "PDF: Overview of popular AI tools today",
            "Built-in Gemini chatbot for Q&A and practice",
      ...
      howSteps: [
        ...
        "Step 4: They use the built-in Gemini tool to ask questions and deepen understanding.",
  ...
  rounded-full border border-gray-300 text-sm font-semibold text-gray-700 hover:bg-gray-300 transition flex items-center gap-2"
          ...
          >
            ...
            <div className="flex items-center gap-2">
              ...
              <span>ChatBot Gemini tích hợp</span>
            </div>
          </motion.div>
        </div>
