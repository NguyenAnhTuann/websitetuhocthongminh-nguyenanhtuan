...
export default function BaiTapKinhTePhapLuat() {
  // === DỮ LIỆU BÀI TẬP KINH TẾ & PHÁP LUẬT ===
  const allExercises = [
    // --- BÀI TẬP KINH TẾ & PHÁP LUẬT ---
    {
      name: "Công dân với pháp luật",
      link: "https://gemini.google.com/share/8089144b0760",
      thumbnail: "https://res.cloudinary.com/duk8odqun/image/upload/v1764235277/Gemini_Generated_Image_j2p1fsj2p1fsj2p9_y6v2x1.png",
      category: "Pháp luật",
  ...
  // Màu chủ đạo mới cho Kinh tế & Pháp luật: Vàng Kim (Amber)
  const primaryColor = "#f59e0b"; // Màu vàng amber-500
  const lightAccentColor = "bg-amber-50";
  const hoverColorClass = "hover:border-[#f59e0b]/50";
  ...
  return (
    ...
    <section className="min-h-screen w-full bg-slate-50 relative overflow-hidden px-4 pt-32 pb-10">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        {/* Màu vàng nhạt */}
        <div className="absolute top-[20%] -right-[10%] w-96 h-96 bg-yellow-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 mb-10">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className={`text-3xl font-extrabold ${textPrimaryColorClass}`}>TƯƠNG TÁC KINH TẾ & PHÁP LUẬT</h1>
            <p className="text-gray-500 text-sm mt-1">
              Tổng hợp tài liệu và bài tập về Kinh tế, Công dân và Pháp luật
            </p>
          </div>
        </div>
              ...
              <button
                ...
                className={`w-10 h-10 rounded-lg font-semibold transition shadow-sm border ${
                  currentPage === page
                    ...
                    : `bg-white text-gray-700 border-gray-300 hover:bg-amber-50 hover:${textPrimaryColorClass}`
                }`}
              >
                {page}
              </button>
