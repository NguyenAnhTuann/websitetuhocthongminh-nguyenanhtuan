...
export default function BaiTapTiengAnh() {
  // === DỮ LIỆU BÀI TẬP TIẾNG ANH ===
  const allExercises = [
    // --- BÀI TẬP TIẾNG ANH (NGỮ PHÁP & TỪ VỰNG) ---
    {
  ...
  // Màu chủ đạo mới cho Tiếng Anh: Xanh dương
  const primaryColor = "#3b82f6"; // Màu xanh blue-500
  const lightAccentColor = "bg-blue-50";
  ...
  return (
    ...
    <section className="min-h-screen w-full bg-slate-50 relative overflow-hidden px-4 pt-32 pb-10">
      ...
      {/* Background Decor: Màu xanh dương */}
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none">
        ...
        {/* Màu xanh nhạt */}
        <div className="absolute top-[20%] -right-[10%] w-96 h-96 bg-cyan-400 rounded-full mix-blend-multiply filter blur-3xl opacity-10 animate-blob animation-delay-2000"></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-center gap-4 mb-10">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className={`text-3xl font-extrabold text-[${primaryColor}]`}>TƯƠNG TÁC TIẾNG ANH</h1>
            <p className="text-gray-500 text-sm mt-1">
              Tổng hợp bài tập thực hành Ngữ pháp và Từ vựng
            </p>
          </div>
        </div>
              ...
              <button
                ...
                className={`w-10 h-10 rounded-lg font-semibold transition shadow-sm border ${
                  currentPage === page
                    ...
                    : `bg-white text-gray-700 border-gray-300 hover:bg-blue-50 hover:text-[${primaryColor}]`
                }`}
              >
                {page}
              </button>
