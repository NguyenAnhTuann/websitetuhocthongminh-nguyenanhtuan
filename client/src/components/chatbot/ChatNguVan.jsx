...
// Import icon môn Ngữ Văn từ react-icons/lu
import { LuBookOpen } from "react-icons/lu";

export default function ChatNguVan() {
  ...
  useEffect(() => {
    setMessages([
      {
        sender: "bot",
        text: "Xin chào! 👋 Tôi là trợ lý AI chuyên về Ngữ Văn. \n\nBạn cần lập dàn ý phân tích tác phẩm, rèn kỹ năng viết văn hay tìm hiểu về tác giả nào không?",
      },
    ]);
  }, []);
      ...
      const res = await fetch(
        "https://websitetuhocthongminh-nguyenanhtuan.onrender.com/api/chat",
        {
          ...
          body: JSON.stringify({
            ...
            subject: "nguvan", // <--- Đổi thành môn Ngữ Văn
    ...
    <section className="min-h-screen w-full flex flex-col items-center px-4 py-16 bg-white">
      ...
      >
        <div className="flex justify-center mb-4">
          <div className="w-20 h-20 bg-[#1c7c76] rounded-2xl flex items-center justify-center shadow-lg">
            {/* Icon Ngữ Văn */}
            <LuBookOpen className="text-white text-4xl" />
          </div>
        </div>
        ...
        <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-base md:text-lg">
          Hỗ trợ Phân tích tác phẩm, Soạn bài, Văn nghị luận & Tiếng Việt.
        </p>
      </motion.div>
      ...
      <div className="w-full max-w-4xl mt-4">
        ...
        <div className="bg-white border border-gray-300 rounded-2xl px-4 py-3 shadow-sm flex items-center gap-2">
          ...
          <input
            value={input}
            placeholder={isTyping ? "AI đang trả lời..." : "Nhập tên tác phẩm, đề bài văn..."}
        ...
        <p className="mt-2 text-xs text-gray-400 text-center">
          ChatBot chuyên môn Ngữ Văn – Powered by AI.
        </p>
      </div>
    </section>
  );
