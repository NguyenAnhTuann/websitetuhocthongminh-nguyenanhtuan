...
// Import icon môn Tin Học từ react-icons/lu
...
export default function ChatTinHoc() {
  ...
  useEffect(() => {
    setMessages([
      {
        sender: "bot",
        text: "Xin chào! 👋 Tôi là trợ lý AI chuyên về Tin Học. \n\nBạn cần hỗ trợ về lập trình (Python, C++, Pascal), thuật toán hay kiến thức máy tính cơ bản không?",
      },
    ]);
  }, []);
      ...
      const res = await fetch(
        "https://websitetuhocthongminh-nguyenanhtuan.onrender.com/api/chat",
        {
          ...
          body: JSON.stringify({
            ...
            subject: "tinhoc", // <--- Đổi thành môn Tin Học
    ...
    <section className="min-h-screen w-full flex flex-col items-center px-4 py-16 bg-white">
      ...
      >
        <div className="flex justify-center mb-4">
          <div className="w-20 h-20 bg-[#1c7c76] rounded-2xl flex items-center justify-center shadow-lg">
            {/* Icon Tin Học */}
            <LuMonitor className="text-white text-4xl" />
          </div>
        </div>
        ...
        <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-base md:text-lg">
          Hỗ trợ Lập trình (Pascal, C++, Python...), Office & Mạng máy tính.
        </p>
      </motion.div>
      ...
      <div className="w-full max-w-4xl mt-4">
        ...
        <div className="bg-white border border-gray-300 rounded-2xl px-4 py-3 shadow-sm flex items-center gap-2">
          ...
          <input
            value={input}
            placeholder={isTyping ? "AI đang trả lời..." : "Viết code Python, hỏi hàm Excel..."}
        ...
        <p className="mt-2 text-xs text-gray-400 text-center">
          ChatBot chuyên môn Tin Học – Powered by AI.
        </p>
      </div>
    </section>
  );
