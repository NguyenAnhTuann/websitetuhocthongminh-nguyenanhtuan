...
export default function ChatTheDuc() {
  ...
  useEffect(() => {
    setMessages([
      {
        sender: "bot",
        text: "Xin chào! 👋 Tôi là trợ lý AI chuyên về Giáo dục thể chất. \n\nBạn cần tìm hiểu luật thi đấu, kỹ thuật các môn thể thao hay phương pháp rèn luyện sức khỏe không?",
      },
    ]);
  }, []);
