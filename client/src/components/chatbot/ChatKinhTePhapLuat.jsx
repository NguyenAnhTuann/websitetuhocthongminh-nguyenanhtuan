...
// Import icon môn Kinh Tế - Pháp Luật từ react-icons/lu
...
export default function ChatKinhTePhapLuat() {
  ...
  useEffect(() => {
    setMessages([
      {
        sender: "bot",
        text: "Xin chào! 👋 Tôi là trợ lý AI chuyên về Kinh tế & Pháp luật. \n\nBạn có thắc mắc về các quy luật kinh tế thị trường, quyền công dân hay hệ thống pháp luật nhà nước không?",
      },
    ]);
  }, []);
      ...
      const res = await fetch(
        "https://websitetuhocthongminh-nguyenanhtuan.onrender.com/api/chat",
        {
          ...
          body: JSON.stringify({
            ...
            subject: "kinhtephapluat", // <--- Đổi thành môn Kinh Tế - Pháp Luật
    ...
    <section className="min-h-screen w-full flex flex-col items-center px-4 py-16 bg-white">
      ...
      >
        <div className="flex justify-center mb-4">
          <div className="w-20 h-20 bg-[#1c7c76] rounded-2xl flex items-center justify-center shadow-lg">
            {/* Icon Kinh Tế - Pháp Luật */}
            <LuScale className="text-white text-4xl" />
          </div>
        </div>

        <h1 className="text-4xl md:text-5xl font-extrabold text-[#1c7c76]">
          ChatBot Kinh Tế – Pháp Luật
        </h1>

        <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-base md:text-lg">
          Hỗ trợ giải đáp kiến thức về Pháp luật, Kinh tế & Tài chính.
        </p>
      </motion.div>
      ...
      <div className="w-full max-w-4xl mt-4">
        ...
        <div className="bg-white border border-gray-300 rounded-2xl px-4 py-3 shadow-sm flex items-center gap-2">
          ...
          <input
            value={input}
            placeholder={isTyping ? "AI đang trả lời..." : "Hỏi về luật dân sự, cung cầu, lạm phát..."}
        ...
        <p className="mt-2 text-xs text-gray-400 text-center">
          ChatBot chuyên môn Kinh Tế – Pháp Luật – Powered by AI.
        </p>
      </div>
    </section>
  );
