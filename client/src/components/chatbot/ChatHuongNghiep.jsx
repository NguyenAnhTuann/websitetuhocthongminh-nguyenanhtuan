...
// Import icon môn Hướng Nghiệp từ react-icons/lu
import { LuCompass } from "react-icons/lu";

export default function ChatHuongNghiep() {
  ...
  useEffect(() => {
    setMessages([
      {
        sender: "bot",
        text: "Xin chào! 👋 Tôi là trợ lý AI về Tư vấn Hướng nghiệp. \n\nBạn đang băn khoăn về việc chọn ngành, chọn nghề, trắc nghiệm tính cách hay cần lời khuyên phát triển bản thân?",
      },
    ]);
  }, []);
      ...
      const res = await fetch(
        "https://websitetuhocthongminh-nguyenanhtuan.onrender.com/api/chat",
        {
          ...
          body: JSON.stringify({
            ...
            subject: "huongnghiep", // <--- Đổi thành môn Hướng Nghiệp
    ...
    <section className="min-h-screen w-full flex flex-col items-center px-4 py-16 bg-white">
      ...
      >
        <div className="flex justify-center mb-4">
          <div className="w-20 h-20 bg-[#1c7c76] rounded-2xl flex items-center justify-center shadow-lg">
            {/* Icon Hướng Nghiệp */}
            <LuCompass className="text-white text-4xl" />
          </div>
        </div>
        ...
        <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-base md:text-lg">
          Tư vấn chọn ngành, chọn nghề & Định hướng tương lai phù hợp.
        </p>
      </motion.div>
      ...
      <div className="w-full max-w-4xl mt-4">
        ...
        <div className="bg-white border border-gray-300 rounded-2xl px-4 py-3 shadow-sm flex items-center gap-2">
          ...
          <input
            value={input}
            placeholder={isTyping ? "AI đang trả lời..." : "Bạn thích làm nghề gì? Sở trường của bạn là gì?..."}
        ...
        <p className="mt-2 text-xs text-gray-400 text-center">
          ChatBot chuyên môn Hướng Nghiệp – Powered by AI.
        </p>
      </div>
    </section>
  );
