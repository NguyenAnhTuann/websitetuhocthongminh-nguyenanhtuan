...
import { LuShield } from "react-icons/lu"; // Icon khiên phù hợp môn Quốc Phòng
    ...
    try {
      const res = await fetch(
        "https://websitetuhocthongminh-nguyenanhtuan.onrender.com/api/chat",
        {
          ...
          body: JSON.stringify({
            message: input,
            subject: "quocphong", // phải khớp backend
          }),
        }
      );
    ...
    <section className="min-h-screen w-full flex flex-col items-center px-4 py-16 bg-white">
      ...
      >
        ...
        <h1 className="text-4xl md:text-5xl font-extrabold text-[#1c7c76]">
          ChatBot Môn Quốc Phòng – An Ninh
        </h1>

        <p className="text-gray-600 mt-3 max-w-2xl mx-auto text-base md:text-lg">
          Trợ lý AI môn Quốc Phòng – An Ninh: cung cấp kiến thức về bảo vệ Tổ quốc,
          kỹ năng quân sự cơ bản, kỷ luật quân đội, sơ cứu – cứu hộ, phòng chống
          tệ nạn xã hội và trách nhiệm công dân.
        </p>
      </motion.div>
      ...
      <div className="w-full max-w-4xl mt-4">
        <div className="bg-white border border-gray-300 rounded-2xl px-4 py-3 shadow-sm flex items-center gap-3">
          <input
            value={input}
            placeholder="Nhập câu hỏi Quốc Phòng – An Ninh..."
        ...
        <p className="mt-2 text-xs text-gray-400 text-center">
          ChatBot chuyên môn Quốc Phòng – An Ninh – Powered by AI.
        </p>
      </div>
