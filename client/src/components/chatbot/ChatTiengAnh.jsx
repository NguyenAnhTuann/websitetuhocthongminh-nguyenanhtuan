...
// Import icon môn Tiếng Anh từ react-icons/lu
import { LuLanguages } from "react-icons/lu";

export default function ChatTiengAnh() {
  ...
  useEffect(() => {
    setMessages([
      {
        sender: "bot",
        text: "Hello! 👋 Tôi là trợ lý AI chuyên về Tiếng Anh. \n\nBạn cần giúp đỡ về ngữ pháp (Grammar), từ vựng (Vocabulary) hay kỹ năng Viết (Writing) không?",
      },
    ]);
  }, []);
      ...
      const res = await fetch(
        "https://websitetuhocthongminh-nguyenanhtuan.onrender.com/api/chat",
        {
          ...
          body: JSON.stringify({
            ...
            subject: "tienganh", // <--- Đổi thành môn Tiếng Anh
    ...
    <section className="min-h-screen w-full flex flex-col items-center px-4 py-16 bg-white">
      ...
      <div className="w-full max-w-4xl mt-4">
        ...
        <div className="bg-white border border-gray-300 rounded-2xl px-4 py-3 shadow-sm flex items-center gap-2">
          ...
          <input
            value={input}
            placeholder={isTyping ? "AI đang trả lời..." : "Dịch câu, hỏi cấu trúc thì, viết đoạn văn..."}
        ...
        <p className="mt-2 text-xs text-gray-400 text-center">
          ChatBot chuyên môn Tiếng Anh – Powered by AI.
        </p>
      </div>
    </section>
  );
